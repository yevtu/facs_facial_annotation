...
from keras.layers import TimeDistributed, Conv2D, Flatten, LSTM, Dense, Input, Concatenate, BatchNormalization, Dropout

def get_model(frameCount=42, nb_classes=7):
    ...
    landmarkEncoder.add(Dropout(0.2))
